...
public class Statistics {
    ...
    private static ArrayList<String> initArrayList(String query, String endpoint, String dataset) throws IOException {
        ...
        RandAccessFileAPI raf = new RandAccessFileAPI(dataset);
    ...
    public static String createEmbeddingData(String entity, RandAccessFileAPI raf, int count) throws IOException {
