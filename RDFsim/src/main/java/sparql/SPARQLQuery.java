...
public class SPARQLQuery {
    ...
    public static JSONObject getAllTriplesOfURI(String s, String endpoint, String from) throws MalformedURLException, ProtocolException, IOException {
        JSONObject allTriples = new JSONObject();

        allTriples.put("asSubject", getTriplesOfURIAsSubject(s, endpoint, from));
        allTriples.put("asObject", getTriplesOfURIAsObject(s, endpoint, from));
